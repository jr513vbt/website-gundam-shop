$(async() => {
    ...
    let ttshopfooter = $("<h4 id='ttshop' class='font-rubik font-size-20'>Shop Gundam</h4>");
    let deailttshopfooter = $("<p id='detailttshop' class='font-size-14 font-rale text-white-50'>Shop chuyển bán các loại mô hình Gundam đủ các thể loại và mẫu mã cho các tính đồ mê Gundam</p>");
